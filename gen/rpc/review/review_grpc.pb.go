...
func (c *reviewServiceClient) GetReviewsByIDs(ctx context.Context, in *GetReviewsByIDsRequest, opts ...grpc.CallOption) (*GetReviewsByIDsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetReviewsByIDsResponse)
...
var ReviewService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "rpc/review/review.proto",
}
